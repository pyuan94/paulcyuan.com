			...
			<!-- Header -->
				<section id="header" class="wrapper">
					...
					<!-- Logo -->
						<div id="logo">
							<h1>Paul Yuan</h1>
							<p>Bachelors in Computer Science | UC Davis 2018</p>
						</div>
			...
			<!-- Footer -->
				...
				<section id="footer" class="wrapper">
					...
					<div class="container">
										...
										<div class="row">
											...
											<div class="col-6 col-12-small">
												<section>
													...
													<p>
														<a href="https://www.linkedin.com/in/paul-yuan-3a1435160/">linkedin.com/in/paul-yuan-3a1435160/</a><br />
						...
						<div id="copyright">
							<ul>
								<li>&copy; Paul Yuan.</li><li>Design: <a href="http://html5up.net">HTML5 UP</a></li>
							</ul>
						</div>
					</div>
				</section>
